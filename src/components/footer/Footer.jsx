            ...
            <div className="container">
                <div className="sm:flex items-center justify-between md:gap-8">
                    <div className="w-full sm:w-1/2">
                        <h2 className="text-[26px] leading-10 text-white font-[600] mb-5 md:text-[2rem]">Velko Mijalkovic Profile</h2>
                        <a target="_blank" rel="noreferrer" href="https://wa.me/27726791891">
                    ...
                    <div className="w-full sm:w-1/2">
                        <p className="text-gray-300 leading-7 mt-4 sm:mt-0">Thank you for visiting my portfolio. If you have any questions or comments, feel free to reach out to me using the contact form.</p>
                        ...
                        <div className="hidden sm:block">
                            <div className="flex items-center gap-[10px]">
                                <span className="w-[35px] h-[35px] rounded-full bg-[#2b2d33] text-white font-[500]
                                 text-[18px] flex items-center justify-center">V</span>
                                 <div className="leading-[20px]">
                                    <h2 className="text-gray-200 font-[500] text-[18px]">Mijalkovic</h2>
                                    <p className="text-gray-400 text-[14px] font-[500]">Personal</p>
                                 </div>
                            </div>
                        </div>
                        <div>
                            <p className="text-gray-400 text-[14px]">Copyright {year} by Velko - All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
